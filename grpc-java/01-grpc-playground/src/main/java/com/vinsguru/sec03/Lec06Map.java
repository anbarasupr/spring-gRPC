...
import com.vinsguru.models.sec03.DealerV;
...
public class Lec06Map {
    ...
    public static void main(String[] args) {
        ...
        var car2000List = Cars.newBuilder()
                .addCarItems(car1)
                .addCarItems(car2)
                .build();
        
        var car2002List = Cars.newBuilder()
        		.addCarItems(car1)
                .addCarItems(car2)
                .build();
        
        var dealerv = DealerV.newBuilder()
                .putInventory(car1.getYear(), car2000List)
                .putInventory(car2.getYear(), car2002List)
                .build();
        
        log.info("dealerv {}", dealerv);
    }
